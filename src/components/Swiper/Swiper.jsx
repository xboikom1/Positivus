    ...
    <div className={css.swiperContainer}>
      ...
      >
        ...
        <SwiperSlide className={clsx(css.swiperContainer, css.swiperSlide)}>
          ...
          <p className={css.bubbleText}>
            "Positivus helped us transform our online presence. Their expertise
            in SEO and digital marketing significantly increased our customer
        ...
        <SwiperSlide className={clsx(css.swiperContainer, css.swiperSlide)}>
          ...
          <p className={css.bubbleText}>
            "Working with Positivus has been a game-changer for us. Their team
            is responsive, innovative, and truly understands our brand needs."
          </p>
          <div className={css.authorInfoContainer}>
